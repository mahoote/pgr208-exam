...
import no.kristiania.prg208_1_exam.controller.utils.Utils.loadImage
import no.kristiania.prg208_1_exam.controller.adapters.SearchImageAdapter
...
import no.kristiania.prg208_1_exam.model.models.CachedImages
                ...
                loadImage(uriString, originalImage, imgTxtStatus,
                    object :
                        ...
                        override fun onSuccess() {
                            ...
                            origBitmap =
                                Utils.drawableToBitmap(originalImage.drawable as BitmapDrawable)
        ...
        if(::adapter.isInitialized) {
            ...
            adapter.setOnItemClickListener(object : SearchImageAdapter.OnItemClickListener {
                override fun onItemClick(position: Int) {
                    ...
                    val chosenBitmapImage =
                        Utils.drawableToBitmap(imageView.drawable as BitmapDrawable)
